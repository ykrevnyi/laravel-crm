...
<script type="text/javascript">
	$('form').on('submit', function(e) {
		var $this = $(this),
			$bnt = $this.find('button[type=submit]');

		$('.project-create-wizzard').addClass('disable');
		...
		.done(function(data) {
			...
			$('.project-create-wizzard').addClass('step-2');

			$bnt.removeAttr('disabled');
			$bnt.html('Сохранить').on('click', function(e) {
				window.location = data.link_to_project;
