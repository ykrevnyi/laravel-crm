	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="text-center">
				Валюта: <span class="create-currency-title">новая валюта</span>
			</h1>
		</div>
	</div>
		...
		<div class="col-lg-12">
			...
			{{ Form::open(array('route' => 'currencies.store', 'class' => 'form-horizontal')) }}
				<div class="form-group">
					...
					<div class="col-sm-9">
						{{ Form::text('name', Input::old('name', ''), array('class' => '2way-binding form-control', 'data-binding' => 'create-currency-title', 'autofocus')) }}
					</div>
				</div>
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-9">
						{{ Form::text('price', Input::old('price', ''), array('class' => 'price-picker form-control')) }}
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						{{ Form::text('unit', Input::old('unit', ''), array('class' => 'unit-picker form-control')) }}
					</div>
				</div>
